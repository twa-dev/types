...
export interface WebApp {
    ...
    checkHomeScreenStatus: (callback?: () => unknown) => void;
    shareMessage: (msgId: string, callback?: () => unknown) => void;
    requestEmojiStatusAccess: (callback?: () => unknown) => void;
    downloadFile: (params: DownloadFileParams[], callback?: () => unknown) => void;
}
...
interface LocationManager {
    ...
    isAccessRequested: boolean;
    isAccessGranted: boolean;
    init: (callback?: () => unknown) => void;
    getLocation: (callback?: () => unknown) => void;
    openSettings: () => void;
}
...
interface ContentSafeAreaInsets {
    top: number;
    bottom: number;
    left: number;
    right: number;
